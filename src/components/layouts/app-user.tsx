...
import { AuthView } from '@/components/auth/auth-drawer';
...
interface AppUserProps {
    ...
    user: User | null;
    openDrawer: (view: AuthView) => void;
}

export default function AppUser({ isAuthenticated, user, openDrawer }: AppUserProps) {
